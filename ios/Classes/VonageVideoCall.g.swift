...
class VonageVideoCallHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: VonageVideoCallHostApi?) {
    let initSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.initSession", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let endSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.endSession", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let switchCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.switchCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let toggleAudioChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.toggleAudio", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let toggleVideoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.toggleVideo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let listAvailableOutputDevicesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.listAvailableOutputDevices", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setOutputDeviceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallHostApi.setOutputDevice", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class VonageVideoCallPlatformApi {
  ...
  func onSessionConnected(connectionId connectionIdArg: String, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallPlatformApi.onSessionConnected", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onConnectionStateChanges(connection connectionArg: ConnectionCallback, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallPlatformApi.onConnectionStateChanges", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onSubscriberConnectionChanges(subscriberConnection subscriberConnectionArg: SubscriberConnectionCallback, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallPlatformApi.onSubscriberConnectionChanges", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onAudioOutputDeviceChange(outputDevice outputDeviceArg: AudioOutputDeviceCallback, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallPlatformApi.onAudioOutputDeviceChange", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([outputDeviceArg] as [Any?]) { _ in
      completion()
    }
  }
  func onError(error errorArg: String, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.VonageVideoCallPlatformApi.onError", binaryMessenger: binaryMessenger, codec: codec)
